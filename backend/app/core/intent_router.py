...
意图说明：
- quiz: 用户明确要求"出题"、"给我几道练习题"、"生成测验"
- flashcard: 用户明确要求"闪卡"、"记忆卡"、"背诵卡片"
- explain: 用户明确要求"解释XX概念"、"什么是XX"、"讲解XX"（需要深度概念讲解）
- notes: 用户明确要求"笔记"、"总结"
- mindmap: 用户明确要求"思维导图"
- learning_bundle: 用户明确要求"学习计划"、"学习包"
- other: 【默认选项】简单问题、计算、追问、闲聊、不明确意图

⚠️ 重要规则：
1. 数学表达式（如"1+1"、"4+4+2"、"3*5"）→ 选择 "other"（简单回答即可）
2. 简单问题追问 → 选择 "other"
3. 只有用户明确说"出题"、"解释概念"等关键词时才选择对应技能
4. 如果不确定，默认选择 "other"
